...
class MainWindow():
    ...
    def __init__(self, application):
        ...
        item.set_image(Gtk.Image.new_from_icon_name("xapp-tools-symbolic", Gtk.IconSize.MENU))
    ...
    def letsgo(self, button):
        ...
        info.message = "%s\n%s" % (_("Your package repositories will now point towards the new release."), _("A few more tests will be run and package updates will be downloaded."))
        self.checks.append(info)
